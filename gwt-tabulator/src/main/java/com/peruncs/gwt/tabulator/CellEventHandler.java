...
public class CellEventHandler {
     ...
     */
    public Callback2<TouchEvent, CellComponent> cellTap;
     ...
     */
    public Callback2<TouchEvent, CellComponent> cellDblTap;
     ...
     */
    public Callback2<TouchEvent, CellComponent> cellTapHold;
     ...
     */
    public Callback1<CellComponent> cellEdited;
